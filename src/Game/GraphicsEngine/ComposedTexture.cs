        ...
        public override Vector2f Dimension
        {
            get
            {
                ...
                switch (Pattern)
                {
                    ...
                    case EPattern.Square:
                        xDimension = Math.Max(Textures[0].Dimension.X, Textures[2].Dimension.X) + Math.Max(Textures[1].Dimension.X, Textures[3].Dimension.X);
                        yDimension = Math.Max(Textures[0].Dimension.Y, Textures[2].Dimension.Y) + Math.Max(Textures[1].Dimension.Y, Textures[3].Dimension.Y);
                        break;
                }
