...
namespace BlazeraLib
{
    public class GameDatas
    {
        ...
        public static void Init()
        {
            ...
            KEY_UP = ScriptEngine.GetList<KeyCode>("KEY_UP");
            KEY_RIGHT = ScriptEngine.GetList<KeyCode>("KEY_RIGHT");
            KEY_DOWN = ScriptEngine.GetList<KeyCode>("KEY_DOWN");
            KEY_LEFT = ScriptEngine.GetList<KeyCode>("KEY_LEFT");
            KEY_ACTION = ScriptEngine.GetList<KeyCode>("KEY_ACTION");
            KEY_BACK = ScriptEngine.GetList<KeyCode>("KEY_BACK");
            KEY_MISC = ScriptEngine.GetList<KeyCode>("KEY_MISC");
            KEY_UP2 = ScriptEngine.GetList<KeyCode>("KEY_UP2");
            KEY_RIGHT2 = ScriptEngine.GetList<KeyCode>("KEY_RIGHT2");
            KEY_DOWN2 = ScriptEngine.GetList<KeyCode>("KEY_DOWN2");
            KEY_LEFT2 = ScriptEngine.GetList<KeyCode>("KEY_LEFT2");
            KEY_ACTION2 = ScriptEngine.GetList<KeyCode>("KEY_ACTION2");
            KEY_SPECIAL0 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL0");
            KEY_SPECIAL1 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL1");
            KEY_SPECIAL2 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL2");
            KEY_SPECIAL3 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL3");
            KEY_SPECIAL4 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL4");
            KEY_SPECIAL5 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL5");
            KEY_SPECIAL6 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL6");
            KEY_SPECIAL7 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL7");
            KEY_SPECIAL8 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL8");
            KEY_SPECIAL9 = ScriptEngine.GetList<KeyCode>("KEY_SPECIAL9");
        }
        ...
        public static List<KeyCode> KEY_UP;
        public static List<KeyCode> KEY_RIGHT;
        public static List<KeyCode> KEY_DOWN;
        public static List<KeyCode> KEY_LEFT;
        public static List<KeyCode> KEY_ACTION;
        public static List<KeyCode> KEY_BACK;
        public static List<KeyCode> KEY_MISC;
        public static List<KeyCode> KEY_UP2;
        public static List<KeyCode> KEY_RIGHT2;
        public static List<KeyCode> KEY_DOWN2;
        public static List<KeyCode> KEY_LEFT2;
        public static List<KeyCode> KEY_ACTION2;
        public static List<KeyCode> KEY_SPECIAL0;
        public static List<KeyCode> KEY_SPECIAL1;
        public static List<KeyCode> KEY_SPECIAL2;
        public static List<KeyCode> KEY_SPECIAL3;
        public static List<KeyCode> KEY_SPECIAL4;
        public static List<KeyCode> KEY_SPECIAL5;
        public static List<KeyCode> KEY_SPECIAL6;
        public static List<KeyCode> KEY_SPECIAL7;
        public static List<KeyCode> KEY_SPECIAL8;
        public static List<KeyCode> KEY_SPECIAL9;
    }
}
